      ...
      <div className={styles.createTaskContainer}>
        <div className={styles.taskTitleForm}>
          ...
          <div className={styles.taskDescription}>
            <div>
              <textarea className={styles.textarea} name="" id="" placeholder="Enter task description"></textarea>
            </div>
          </div>
        </div>
        ...
        <div className={styles.taskCreateOptions} style={{ display: "flex", flexDirection: "column", }}>
          ...
          <a style={{ alignSelf: "flex-end" }} href="#" className={styles.btnLocal}>Add Task</a>
        </div>
      </div >
    </div>
  );
