...
const CreateTask: React.FC<TaskProps> = (props: TaskProps) => {
        ...
        <div className={styles.createTaskContainer}>
          ...
          <div className={styles.taskDetailsForm}>
            <div className={styles.priorityCategoryRepetition}>
              ...
              {/* Map over the taskCategory prop and render an option element for each category */}
              <select className={styles.formSelect} id={styles.taskPriority}>
                {taskCategory.map(category => (
                  <option className={styles.option} value={category}>{category}</option>
                ))}
              </select>
