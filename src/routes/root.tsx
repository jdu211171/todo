...
import { faCalendarDays, faUserSecret, faRightToBracket, faChevronRight, faList, faCalendarDay, faRotateRight, faThumbsUp, faBoxOpen, faRightFromBracket, faFolderPlus } from "@fortawesome/free-solid-svg-icons";
